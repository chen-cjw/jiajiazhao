...
//            ),
            ...
            'image'=>array(
                ...
                array(
                    'url'=>$shop->images?json_encode($shop->images[0]):config('app.url')."/XuZBGE4VcDCcUqDbtzkzDfJ5wT9cEAl0SsHTBNWp.jpg",//json_encode($shop->logo['store_logo']),//config('app.url')."/XuZBGE4VcDCcUqDbtzkzDfJ5wT9cEAl0SsHTBNWp.jpg",
                    'left'=>60,
                    'top'=>1530,
                    'right'=>0,
                    'stream'=>0,
