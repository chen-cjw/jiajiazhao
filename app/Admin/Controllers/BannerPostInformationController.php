...
class BannerPostInformationController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new BannerPostInformation());
    ...
    {
        $show = new Show(BannerPostInformation::findOrFail($id));
    ...
    {
        $form = new Form(new BannerPostInformation());
        ...
        BannerPostInformation::baseBanner($form);
